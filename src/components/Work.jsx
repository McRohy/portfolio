...
function Work() {
  return (
    <section id="Work" className=" py-20 px-6 text-center">
      ...
      <div className="overflow-x-auto overflow-y-hidden center">
        <div className="flex gap-8 min-w-[1200px] px-4 " >
          {works.map((work, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              <div className="p-6 text-left ">
                <h3 className="text-2xl font-semibold mb-2 flex justify-between w-full">
                  {work.title}
                  <span className=" items-end bg-black text-white text-xs px-3 py-2 rounded-full right-1/2">
                    {work.year}
                  </span>
                  </h3>
